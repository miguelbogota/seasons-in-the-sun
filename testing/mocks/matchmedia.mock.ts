// Rule disbaled since this is a mock file, the real matchMedia is also implemented this way and
// since the method signature is easy to understand this way.
/* eslint-disable @typescript-eslint/method-signature-style, @typescript-eslint/no-explicit-any */

type ListenerCallback = (this: MediaQueryList, ev: MediaQueryListEvent) => any;

interface MediaQueryList {
  readonly matches: boolean;
  readonly media: string;
  onchange: ListenerCallback | null;
  /** @deprecated */
  addListener(callback: ListenerCallback | null): void;
  /** @deprecated */
  removeListener(callback: ListenerCallback | null): void;
...
export class MatchMediaMock {
  private mediaQueries: Record<string, MediaQueryListener[]> = {};
